...
const FRENCH_REPLACEMENTS: UiReplacement[] = [
  ...
  { pattern: /Bias Radar \(8-Factor\)/g, value: 'Radar des biais (8 facteurs)' },
  ...
  { pattern: /Overconfidence/g, value: 'Surconfiance' },
  { pattern: /Concentration Bias/g, value: 'Biais de concentration' },
  ...
  { pattern: /8-factor bias radar \(0-100\)/g, value: 'Radar des biais a 8 facteurs (0-100)' },
